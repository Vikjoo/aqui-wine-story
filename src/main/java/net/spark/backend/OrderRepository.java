...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	@EntityGraph(value = "Order.gridData", type = EntityGraphType.LOAD)
	Page<Order> findByCustomerLastNameContainingIgnoreCase(String searchQuery, Pageable pageable);

	@EntityGraph(value = "Order.gridData", type = EntityGraphType.LOAD)
	Page<Order> findByCustomerLastNameContainingIgnoreCaseAndDueDateAfter(String searchQuery, LocalDate dueDate,
			Pageable pageable);
	...
	long countByCustomerLastNameContainingIgnoreCase(String searchQuery);

	long countByCustomerLastNameContainingIgnoreCaseAndDueDateAfter(String searchQuery, LocalDate dueDate);
