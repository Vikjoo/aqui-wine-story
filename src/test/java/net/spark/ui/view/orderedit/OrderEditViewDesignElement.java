...
@ServerClass("net.jiniguru.roshan.ui.view.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(net.jiniguru.roshan.ui.view.orderedit.OrderHistoryElement.class).id("history");
	}
