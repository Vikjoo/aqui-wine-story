...
public class UpdateOrderIT extends AbstractIT {
	...
	public void updateButCancel() {
		...
		String updatedPickupLocation = "Store".equals(currentOrder.pickupLocation) ? "Online" : "Store";
	...
	public void confirmDialogAfterCustomerChanges() {
		...
		TextFieldElement firstName = orderEditView.getFirstName();
		firstName.setValue(firstName.getValue() + "foo");

		TextFieldElement lastName = orderEditView.getFirstName();
		firstName.setValue(lastName.getValue() + "foo");
	...
	public void concurrentEditing() {
		...
		orderEditView.getEditOrCancel().click();
		TextFieldElement firstName = orderEditView.getFirstName();
		firstName.setValue(firstName.getValue() + "-edited-by-user-1");
		TextFieldElement lastName = orderEditView.getLastName();
		firstName.setValue(lastName.getValue() + "-edited-by-user-1");
		...
		try {
			...
			TextFieldElement otherUserFullName = otherUserOrderEditView.getFirstName();
