...
public final class AdministrationRackCommand
extends Command {
    public AdministrationRackCommand(IApplication application) {
        super(application);
    }
    ...
    public void execute() {
        ...
        IWindow window = this.getApp().createWindow(WindowType.RackAdministration, new Object[0]);
        if (window != null) {
            window.show();
        }
